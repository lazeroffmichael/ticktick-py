...
class TestGetSummary:
    ...
    def test_get_summary_invalid_time_zone(self, client):
        ...
        with pytest.raises(KeyError):
            client.get_summary(start, end, time_zone=tz)
    ...
    def test_get_summary_single_day_good_return(self, client):
        ...
        start = datetime(2020, 12, 14)
        tasks = client.get_summary(start)
        assert tasks[0] != ''
    ...
    def test_get_summary_single_day_full_day_false(self, client):
        ...
        tasks = client.get_summary(start, full_day=False)
        assert tasks[0] != ''
    ...
    def test_get_summary_multi_day_full_good_return(self, client):
        ...
        tasks = client.get_summary(start, end)
        assert tasks[0] != ''
    ...
    def test_get_summary_multi_day_not_full_day_good_return(self, client):
        ...
        tasks = client.get_summary(start, end, full_day=False)
        assert tasks[0] != ''
